...
var _mrpinsky$elm_keyed_list$KeyedList$encodeKeyed = F2(
	function (encodeItem, _p0) {
		var _p1 = _p0;
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'item',
						_1: encodeItem(_p1._1)
					},
					_1: {ctor: '[]'}
				}
			});
	});
var _mrpinsky$elm_keyed_list$KeyedList$encode = F2(
	function (encodeItem, _p2) {
		var _p3 = _p2;
		return _elm_lang$core$Json_Encode$object(
			{
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'nextKey',
					_1: _elm_lang$core$Json_Encode$int(_p3._0._0)
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: _elm_lang$core$Json_Encode$list(
							A2(
								_elm_lang$core$List$map,
								_mrpinsky$elm_keyed_list$KeyedList$encodeKeyed(encodeItem),
								_p3._1))
					},
					_1: {ctor: '[]'}
				}
...
var _mrpinsky$elm_keyed_list$KeyedList$length = function (_p4) {
	var _p5 = _p4;
	return _elm_lang$core$List$length(_p5._1);
};
var _mrpinsky$elm_keyed_list$KeyedList$isEmpty = function (_p6) {
	var _p7 = _p6;
	return _elm_lang$core$List$isEmpty(_p7._1);
};
var _mrpinsky$elm_keyed_list$KeyedList$keyedMap = F2(
	function (fn, _p8) {
		var _p9 = _p8;
		var keyedMapHelper = function (_p10) {
			var _p11 = _p10;
			return A2(fn, _p11._0, _p11._1);
		};
		return A2(_elm_lang$core$List$map, keyedMapHelper, _p9._1);
	});
var _mrpinsky$elm_keyed_list$KeyedList$toList = function (_p12) {
	var _p13 = _p12;
	var keyedMapHelper = function (_p14) {
		var _p15 = _p14;
		return _p15._1;
	};
	return A2(_elm_lang$core$List$map, keyedMapHelper, _p13._1);
};
var _mrpinsky$elm_keyed_list$KeyedList$KeyedList = F2(
	function (a, b) {
		return {ctor: 'KeyedList', _0: a, _1: b};
	});
var _mrpinsky$elm_keyed_list$KeyedList$remove = F2(
	function (key, _p16) {
		var _p17 = _p16;
		var removeHelper = function (_p18) {
			var _p19 = _p18;
			return !_elm_lang$core$Native_Utils.eq(_p19._0, key);
		};
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p17._0,
			A2(_elm_lang$core$List$filter, removeHelper, _p17._1));
	});
var _mrpinsky$elm_keyed_list$KeyedList$filter = F2(
	function (predicate, _p20) {
		var _p21 = _p20;
		var filterHelper = function (_p22) {
			var _p23 = _p22;
			return predicate(_p23._1);
		};
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p21._0,
			A2(_elm_lang$core$List$filter, filterHelper, _p21._1));
	});
var _mrpinsky$elm_keyed_list$KeyedList$Keyed = F2(
	function (a, b) {
		return {ctor: 'Keyed', _0: a, _1: b};
	});
var _mrpinsky$elm_keyed_list$KeyedList$update = F3(
	function (key, fn, _p24) {
		var _p25 = _p24;
		var updateHelper = function (_p26) {
			var _p27 = _p26;
			var _p29 = _p27._1;
			var _p28 = _p27._0;
			return _elm_lang$core$Native_Utils.eq(_p28, key) ? A2(
				_mrpinsky$elm_keyed_list$KeyedList$Keyed,
				_p28,
				fn(_p29)) : A2(_mrpinsky$elm_keyed_list$KeyedList$Keyed, _p28, _p29);
		};
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p25._0,
			A2(_elm_lang$core$List$map, updateHelper, _p25._1));
	});
var _mrpinsky$elm_keyed_list$KeyedList$map = F2(
	function (fn, _p30) {
		var _p31 = _p30;
		var mapHelper = function (_p32) {
			var _p33 = _p32;
			return A2(
				_mrpinsky$elm_keyed_list$KeyedList$Keyed,
				_p33._0,
		...
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p31._0,
			A2(_elm_lang$core$List$map, mapHelper, _p31._1));
	});
var _mrpinsky$elm_keyed_list$KeyedList$Key = function (a) {
	return {ctor: 'Key', _0: a};
};
var _mrpinsky$elm_keyed_list$KeyedList$empty = A2(
	_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
	_mrpinsky$elm_keyed_list$KeyedList$Key(0),
	{ctor: '[]'});
var _mrpinsky$elm_keyed_list$KeyedList$next = function (_p34) {
	var _p35 = _p34;
	return _mrpinsky$elm_keyed_list$KeyedList$Key(_p35._0 + 1);
};
var _mrpinsky$elm_keyed_list$KeyedList$cons = F2(
	function (item, _p36) {
		var _p37 = _p36;
		var _p38 = _p37._0;
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_mrpinsky$elm_keyed_list$KeyedList$next(_p38),
			{
				ctor: '::',
				_0: A2(_mrpinsky$elm_keyed_list$KeyedList$Keyed, _p38, item),
				_1: _p37._1
			});
	});
var _mrpinsky$elm_keyed_list$KeyedList$push = F2(
	function (item, _p39) {
		var _p40 = _p39;
		var _p41 = _p40._0;
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_mrpinsky$elm_keyed_list$KeyedList$next(_p41),
			A2(
				F2(
					function (x, y) {
				...
				_elm_lang$core$List$singleton(
					A2(_mrpinsky$elm_keyed_list$KeyedList$Keyed, _p41, item))));
	});
var _mrpinsky$elm_keyed_list$KeyedList$fromList = function (items) {
	var fromListHelper = F2(
		function (index, item) {
			return A2(
				_mrpinsky$elm_keyed_list$KeyedList$Keyed,
				_mrpinsky$elm_keyed_list$KeyedList$Key(index),
				item);
		});
	return A2(
		_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
		_mrpinsky$elm_keyed_list$KeyedList$Key(
			_elm_lang$core$List$length(items)),
		A2(_elm_lang$core$List$indexedMap, fromListHelper, items));
};
var _mrpinsky$elm_keyed_list$KeyedList$keyDecoder = A2(_elm_lang$core$Json_Decode$map, _mrpinsky$elm_keyed_list$KeyedList$Key, _elm_lang$core$Json_Decode$int);
var _mrpinsky$elm_keyed_list$KeyedList$keyedDecoder = function (itemDecoder) {
	return A3(
		_elm_lang$core$Json_Decode$map2,
		_mrpinsky$elm_keyed_list$KeyedList$Keyed,
		A2(_elm_lang$core$Json_Decode$field, 'key', _mrpinsky$elm_keyed_list$KeyedList$keyDecoder),
		A2(_elm_lang$core$Json_Decode$field, 'item', itemDecoder));
};
var _mrpinsky$elm_keyed_list$KeyedList$decoder = function (itemDecoder) {
	return A3(
		_elm_lang$core$Json_Decode$map2,
		_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
		A2(_elm_lang$core$Json_Decode$field, 'nextKey', _mrpinsky$elm_keyed_list$KeyedList$keyDecoder),
		A2(
			_elm_lang$core$Json_Decode$field,
			'items',
			_elm_lang$core$Json_Decode$list(
				_mrpinsky$elm_keyed_list$KeyedList$keyedDecoder(itemDecoder))));
};
...
var _user$project$Tagged$match = F2(
	function (tag, item) {
		return _elm_lang$core$Native_Utils.eq(item.tag, tag);
	});
var _user$project$Tagged$update = F3(
	function (fn, tag, item) {
		return _elm_lang$core$Native_Utils.eq(tag, item.tag) ? fn(item) : item;
	});

var _user$project$Util$viewField = F2(
	function (label, inputEl) {
		return A2(
...
var _user$project$Util$normalize = F2(
	function (max, scaled) {
		return scaled / max;
	});
var _user$project$Util$fade = F2(
	function (_p0, tally) {
		var _p1 = _p0;
		var curve = _elm_lang$core$Basics$sqrt;
		var opaqueAt = 10;
		var alpha = A2(
			_user$project$Util$normalize,
			curve(opaqueAt),
			curve(
				_elm_lang$core$Basics$toFloat(tally)));
		return A4(_rtfeldman$elm_css$Css$rgba, _p1.red, _p1.green, _p1.blue, alpha);
	});
var _user$project$Util$subdivide = F2(
	function (subSize, list) {
		return (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(list),
			subSize) < 1) ? _elm_lang$core$List$singleton(list) : A2(
			F2(
				function (x, y) {
					return {ctor: '::', _0: x, _1: y};
				}),
			A2(_elm_lang$core$List$take, subSize, list),
			A2(
				_user$project$Util$subdivide,
				subSize,
				A2(_elm_lang$core$List$drop, subSize, list)));
	});
var _user$project$Util$keyedListDecoder = function (decoder) {
	return A2(
		_elm_lang$core$Json_Decode$map,
		_mrpinsky$elm_keyed_list$KeyedList$fromList,
		_elm_lang$core$Json_Decode$list(decoder));
};
var _user$project$Util$encodeKeyedList = F2(
	function (encoder, keyedList) {
		return _elm_lang$core$Json_Encode$list(
			A2(
				_elm_lang$core$List$map,
				encoder,
				_mrpinsky$elm_keyed_list$KeyedList$toList(keyedList)));
	});
var _user$project$Util$styles = function (_p2) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p2));
};
var _user$project$Util$viewWithRemoveButton = F2(
	function (msg, html) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
...
var _user$project$Util$onChange = function (tagger) {
	...
	return A2(
		_elm_lang$html$Html_Events$on,
		'change',
		A2(_elm_lang$core$Json_Decode$map, tagger, innerHtmlDecoder));
};
...
var _user$project$Util$stringFromCode = function (_p3) {
	return _elm_lang$core$String$fromChar(
		_elm_lang$core$Char$fromCode(_p3));
};
var _user$project$Util$delta = _user$project$Util$stringFromCode(916);
var _user$project$Util$emdash = _user$project$Util$stringFromCode(8212);
var _user$project$Util$checkmark = _user$project$Util$stringFromCode(10004);
var _user$project$Util$encodeMaybe = F2(
	function (encoder, maybe) {
		...
		if (_p4.ctor === 'Nothing') {
			...
			return encoder(_p4._0);
		}
	});
var _user$project$Util$colorDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_rtfeldman$elm_css$Css$rgba,
	A2(_elm_lang$core$Json_Decode$field, 'red', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'green', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'blue', _elm_lang$core$Json_Decode$int),
...
var _user$project$Util$encodeColor = function (color) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: A2(
				...
				'red',
				_elm_lang$core$Json_Encode$int(color.red)),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Util_ops['=>'],
					'green',
					_elm_lang$core$Json_Encode$int(color.green)),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Util_ops['=>'],
						'blue',
						_elm_lang$core$Json_Encode$int(color.blue)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Util_ops['=>'],
							'alpha',
							_elm_lang$core$Json_Encode$float(color.alpha)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Quiz_Observation_Style$parseWeight = F2(
...
var _user$project$Quiz_Observation_Style$viewAsButton = F2(
	function (attrs, _p0) {
		var _p1 = _p0;
		var attributes = A2(
			_elm_lang$core$Basics_ops['++'],
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('topic button'),
				_1: {
					ctor: '::',
					_0: _user$project$Util$styles(
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$backgroundColor(_p1.color),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Quiz_Observation_Style$update = F2(
	function (msg, style) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'UpdateSymbol':
...
var _user$project$Quiz_Observation_Style$UpdateTextColor = function (a) {
	return {ctor: 'UpdateTextColor', _0: a};
};
var _user$project$Quiz_Observation_Style$UpdateWeight = function (a) {
	return {ctor: 'UpdateWeight', _0: a};
};
var _user$project$Quiz_Observation_Style$UpdateColor = function (a) {
	return {ctor: 'UpdateColor', _0: a};
};
var _user$project$Quiz_Observation_Style$UpdateLabel = function (a) {
	return {ctor: 'UpdateLabel', _0: a};
};
var _user$project$Quiz_Observation_Style$UpdateSymbol = function (a) {
	return {ctor: 'UpdateSymbol', _0: a};
};
var _user$project$Quiz_Observation_Style$view = F2(
	function (_p3, style) {
		var _p4 = _p3;
		var _p7 = _p4.onUpdate;
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							_p7,
							A2(
								_user$project$Util$viewField,
								'Label',
								A2(
									_elm_lang$html$Html$input,
									{
										ctor: '::',
										_0: _user$project$Util$onChange(_user$project$Quiz_Observation_Style$UpdateLabel),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(style.label),
											_1: {
												ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_p4.remove),
									_1: {
										ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('row small-fields'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									A2(
										...
										{
											ctor: '::',
											_0: _user$project$Util$onChange(_user$project$Quiz_Observation_Style$UpdateSymbol),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$maxlength(1),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(style.symbol),
													_1: {
														ctor: '::',
										...
										A2(
											_elm_lang$html$Html$input,
											{
												...
												_0: _elm_lang$html$Html_Events$onInput(
													function (_p5) {
														return _user$project$Quiz_Observation_Style$UpdateColor(
															_rtfeldman$elm_css$Css$hex(_p5));
													}),
												_1: {
													ctor: '::',
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$value(style.color.value),
														_1: {
															ctor: '::',
											...
											A2(
												_elm_lang$html$Html$input,
												{
													...
													_0: _user$project$Util$onChange(
														function (_p6) {
															return _user$project$Quiz_Observation_Style$UpdateWeight(
																A2(_user$project$Quiz_Observation_Style$parseWeight, style.weight, _p6));
														}),
													_1: {
														ctor: '::',
														...
														_1: {
															...
															_0: _elm_lang$html$Html_Attributes$value(
																_elm_lang$core$Basics$toString(style.weight)),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('weight'),
																_1: {ctor: '[]'}
															}
														}
													}
...
var _user$project$Quiz_Theme$idDecoder = _elm_lang$core$Json_Decode$string;
var _user$project$Quiz_Theme$encodeId = function (id) {
	return _elm_lang$core$Json_Encode$string(id);
};
var _user$project$Quiz_Theme$encodeTopic = function (topic) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: A2(
				_user$project$Util_ops['=>'],
				'id',
				_user$project$Quiz_Theme$encodeId(topic.id)),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Util_ops['=>'],
					'symbol',
					_elm_lang$core$Json_Encode$string(topic.symbol)),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Util_ops['=>'],
						'label',
						_elm_lang$core$Json_Encode$string(topic.label)),
					_1: {
						ctor: '::',
						_0: A2(
							_user$project$Util_ops['=>'],
							'color',
							_user$project$Util$encodeColor(topic.color)),
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$Util_ops['=>'],
								'weight',
								_elm_lang$core$Json_Encode$int(topic.weight)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Quiz_Theme$encode = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$list(
		_mgold$elm_nonempty_list$List_Nonempty$toList(
			A2(_mgold$elm_nonempty_list$List_Nonempty$map, _user$project$Quiz_Theme$encodeTopic, _p1._1)));
};
var _user$project$Quiz_Theme$viewButton = F2(
	function (toMsg, topic) {
		return A2(
			_user$project$Quiz_Observation_Style$viewAsButton,
			{
				ctor: '::',
...
var _user$project$Quiz_Theme$viewAsButtons = F2(
	function (toMsg, _p2) {
		var _p3 = _p2;
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('theme buttons'),
				_1: {ctor: '[]'}
			},
			_mgold$elm_nonempty_list$List_Nonempty$toList(
				A2(
					_mgold$elm_nonempty_list$List_Nonempty$map,
					_user$project$Quiz_Theme$viewButton(toMsg),
					_p3._1)));
	});
var _user$project$Quiz_Theme$idList = function (_p4) {
	var _p5 = _p4;
	return A2(
		_mgold$elm_nonempty_list$List_Nonempty$map,
		function (_) {
...
var _user$project$Quiz_Theme$toList = function (_p6) {
	var _p7 = _p6;
	return _mgold$elm_nonempty_list$List_Nonempty$toList(_p7._1);
};
var _user$project$Quiz_Theme$defaultTopic = {
	id: 'default',
	symbol: _user$project$Util$checkmark,
	label: '+',
	color: _rtfeldman$elm_css$Css$hex('ffffff'),
	weight: 0,
	textColor: _rtfeldman$elm_css$Css$hex('000000')
};
var _user$project$Quiz_Theme$lookup = F2(
	function (target, _p8) {
		var _p9 = _p8;
		var lookupHelper = function (_p10) {
			var _p11 = _p10;
			return _elm_lang$core$Native_Utils.eq(_p11.id, target);
		};
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$Quiz_Theme$defaultTopic,
			_elm_lang$core$List$head(
				A2(
					_elm_lang$core$List$filter,
					lookupHelper,
					_mgold$elm_nonempty_list$List_Nonempty$toList(_p9._1))));
	});
var _user$project$Quiz_Theme$initTopic = function (id) {
	return {
		id: id,
		symbol: _user$project$Util$checkmark,
		label: 'Observation Category',
		color: _rtfeldman$elm_css$Css_Colors$green,
		weight: 1,
		textColor: _rtfeldman$elm_css$Css$hex('000000')
	};
};
var _user$project$Quiz_Theme$defaultTopics = {
	ctor: '::',
	_0: {id: 'obs', symbol: '+', label: 'Plus', color: _rtfeldman$elm_css$Css_Colors$green, weight: 1, textColor: _rtfeldman$elm_css$Css_Colors$black},
	_1: {
		ctor: '::',
		_0: {id: 'question', symbol: '?', label: 'Question', color: _rtfeldman$elm_css$Css_Colors$yellow, weight: 0, textColor: _rtfeldman$elm_css$Css_Colors$black},
		_1: {
			ctor: '::',
			_0: {
				id: 'delta',
				symbol: _user$project$Util$delta,
				label: 'Delta',
				color: _rtfeldman$elm_css$Css_Colors$red,
				weight: -1,
				textColor: _rtfeldman$elm_css$Css$hex('ffffff')
			},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Quiz_Theme$Topic = F6(
	function (a, b, c, d, e, f) {
		return {id: a, symbol: b, label: c, color: d, weight: e, textColor: f};
	});
var _user$project$Quiz_Theme$topicDecoder = A7(
	_elm_lang$core$Json_Decode$map6,
	_user$project$Quiz_Theme$Topic,
	A2(_elm_lang$core$Json_Decode$field, 'id', _user$project$Quiz_Theme$idDecoder),
	...
	A2(_elm_lang$core$Json_Decode$field, 'color', _user$project$Util$colorDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'weight', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'textColor', _user$project$Util$colorDecoder));
var _user$project$Quiz_Theme$Theme = F2(
	function (a, b) {
		return {ctor: 'Theme', _0: a, _1: b};
	});
var _user$project$Quiz_Theme$init = A2(
	_user$project$Quiz_Theme$Theme,
	2,
	_mgold$elm_nonempty_list$List_Nonempty$fromElement(
		_user$project$Quiz_Theme$initTopic('1')));
var _user$project$Quiz_Theme$default = A2(
	_user$project$Quiz_Theme$Theme,
	1,
	A2(
		_elm_lang$core$Maybe$withDefault,
		_mgold$elm_nonempty_list$List_Nonempty$fromElement(
			_user$project$Quiz_Theme$initTopic('1')),
		_mgold$elm_nonempty_list$List_Nonempty$fromList(_user$project$Quiz_Theme$defaultTopics)));
var _user$project$Quiz_Theme$update = F2(
	function (msg, _p12) {
		var _p13 = _p12;
		var _p16 = _p13._1;
		var _p15 = _p13._0;
			...
			case 'Add':
				return A2(
					...
					A2(
						...
						_p16,
						_mgold$elm_nonempty_list$List_Nonempty$fromElement(
							_user$project$Quiz_Theme$initTopic(
								_elm_lang$core$Basics$toString(_p15)))));
			case 'Remove':
				var removeHelper = function (topic) {
					return !_elm_lang$core$Native_Utils.eq(topic.id, _p14._0);
				};
				return A2(
					_user$project$Quiz_Theme$Theme,
					_p15,
					A3(
						_mgold$elm_nonempty_list$List_Nonempty$filter,
						removeHelper,
						_mgold$elm_nonempty_list$List_Nonempty$head(_p16),
						_p16));
			default:
				var updateHelper = function (topic) {
					return _elm_lang$core$Native_Utils.eq(topic.id, _p14._0) ? A2(_user$project$Quiz_Observation_Style$update, _p14._1, topic) : topic;
				};
				return A2(
					_user$project$Quiz_Theme$Theme,
					_p15,
					A2(_mgold$elm_nonempty_list$List_Nonempty$map, updateHelper, _p16));
		}
	});
var _user$project$Quiz_Theme$reconstruct = function (topics) {
	var nextId = A2(
		_elm_lang$core$Maybe$withDefault,
		_mgold$elm_nonempty_list$List_Nonempty$length(topics),
		_elm_lang$core$Result$toMaybe(
			_elm_lang$core$String$toInt(
				function (_) {
					return _.id;
				}(
					A2(_mgold$elm_nonempty_list$List_Nonempty$get, -1, topics)))));
	return A2(_user$project$Quiz_Theme$Theme, nextId, topics);
};
var _user$project$Quiz_Theme$decoder = A2(
	_elm_lang$core$Json_Decode$map,
	_elm_lang$core$Maybe$withDefault(_user$project$Quiz_Theme$init),
	A2(
		_elm_lang$core$Json_Decode$map,
		_elm_lang$core$Maybe$map(_user$project$Quiz_Theme$reconstruct),
		A2(
			_elm_lang$core$Json_Decode$map,
			_mgold$elm_nonempty_list$List_Nonempty$fromList,
			_elm_lang$core$Json_Decode$list(_user$project$Quiz_Theme$topicDecoder))));
var _user$project$Quiz_Theme$UpdateStyle = F2(
	function (a, b) {
		return {ctor: 'UpdateStyle', _0: a, _1: b};
	});
var _user$project$Quiz_Theme$Remove = function (a) {
	return {ctor: 'Remove', _0: a};
};
var _user$project$Quiz_Theme$viewTopic = function (topic) {
	return A2(
		_elm_lang$html$Html$li,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('topic editable'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				_user$project$Quiz_Observation_Style$view,
				{
					onUpdate: _user$project$Quiz_Theme$UpdateStyle(topic.id),
					remove: _user$project$Quiz_Theme$Remove(topic.id)
				},
				topic),
			_1: {ctor: '[]'}
		});
};
var _user$project$Quiz_Theme$Add = {ctor: 'Add'};
var _user$project$Quiz_Theme$viewAsEditable = function (_p17) {
	var _p18 = _p17;
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$List$map,
					_user$project$Quiz_Theme$viewTopic,
					_mgold$elm_nonempty_list$List_Nonempty$toList(_p18._1))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Quiz_Theme$Add),
						_1: {
							ctor: '::',
...
var _user$project$Quiz_Observation$encode = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: A2(
				_user$project$Util_ops['=>'],
				'style',
				_user$project$Quiz_Theme$encodeId(_p1.style)),
			_1: {
				ctor: '::',
				_0: A2(
					_user$project$Util_ops['=>'],
					'label',
					_elm_lang$core$Json_Encode$string(_p1.label)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Quiz_Observation$viewSelectableStyle = F2(
	function (currentlySelected, _p2) {
		var _p3 = _p2;
		var _p4 = _p3.id;
		return A2(
			_elm_lang$html$Html$option,
			{
				...
				_0: _elm_lang$html$Html_Attributes$selected(
					_elm_lang$core$Native_Utils.eq(currentlySelected, _p4)),
				_1: {
					ctor: '::',
...
var _user$project$Quiz_Observation$update = F2(
	function (msg, observation) {
		var _p5 = msg;
		if (_p5.ctor === 'UpdateLabel') {
			return _elm_lang$core$Native_Utils.update(
				observation,
				{label: _p5._0});
		} else {
...
var _user$project$Quiz_Observation$isEmpty = function (_p6) {
	var _p7 = _p6;
	return _elm_lang$core$Native_Utils.eq(_p7.label, '');
};
var _user$project$Quiz_Observation$Observation = F2(
	function (a, b) {
		return {style: a, label: b};
	});
var _user$project$Quiz_Observation$init = function (style) {
	return A2(_user$project$Quiz_Observation$Observation, style, '');
};
var _user$project$Quiz_Observation$decoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Quiz_Observation$Observation,
	A2(_elm_lang$core$Json_Decode$field, 'style', _user$project$Quiz_Theme$idDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'label', _elm_lang$core$Json_Decode$string));
var _user$project$Quiz_Observation$UpdateStyle = function (a) {
	return {ctor: 'UpdateStyle', _0: a};
};
var _user$project$Quiz_Observation$UpdateLabel = function (a) {
	return {ctor: 'UpdateLabel', _0: a};
};
var _user$project$Quiz_Observation$view = function (observation) {
	return A2(
		_elm_lang$html$Html$span,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(_user$project$Quiz_Observation$UpdateLabel),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('label static'),
					_1: {ctor: '[]'}
				}
			}
		},
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text(observation.label),
			_1: {ctor: '[]'}
		});
};
var _user$project$Quiz_Observation$viewCreating = F3(
	function (updateHandler, commitHandler, observation) {
		return A2(
			_elm_lang$html$Html$input,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onInput(
					function (_p8) {
						return updateHandler(
							_user$project$Quiz_Observation$UpdateLabel(_p8));
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Util$onEnter(commitHandler),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(observation.label),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('observation creating'),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Quiz_Observation$viewToRelabel = function (_p9) {
	var _p10 = _p9;
	return A2(
		_user$project$Util$viewField,
		'Description',
		A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$value(_p10.label),
				_1: {
					ctor: '::',
					_0: _user$project$Util$onChange(_user$project$Quiz_Observation$UpdateLabel),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('label editable'),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _user$project$Quiz_Observation$viewAsProto = F3(
	function (_p11, theme, observation) {
		var _p12 = _p11;
		var _p13 = _p12.onUpdate;
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('observation'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					A2(
						...
						A2(
							...
							{
								ctor: '::',
								_0: _user$project$Util$onChange(_user$project$Quiz_Observation$UpdateStyle),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('topic'),
									_1: {ctor: '[]'}
							...
							A2(
								_elm_lang$core$List$map,
								_user$project$Quiz_Observation$viewSelectableStyle(observation.style),
								_user$project$Quiz_Theme$toList(theme))))),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$map,
						_p13,
						_user$project$Quiz_Observation$viewToRelabel(observation)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_p12.remove),
									_1: {ctor: '[]'}
								}
							},
							{
...
var _user$project$Quiz_Observation_Record$encodeState = function (state) {
	var _p0 = state;
	if (_p0.ctor === 'Struck') {
		return _elm_lang$core$Json_Encode$null;
	} else {
...
var _user$project$Quiz_Observation_Record$value = F2(
	function (theme, _p1) {
		var _p2 = _p1;
		var _p3 = _p2.state;
		if (_p3.ctor === 'Struck') {
			...
			var weight = function (_) {
				return _.weight;
			}(
				A2(_user$project$Quiz_Theme$lookup, _p2.observation.style, theme));
			return _p3._0 * weight;
		}
	});
var _user$project$Quiz_Observation_Record$Record = F2(
	function (a, b) {
		return {observation: a, state: b};
	});
var _user$project$Quiz_Observation_Record$Active = function (a) {
	return {ctor: 'Active', _0: a};
};
var _user$project$Quiz_Observation_Record$init = F2(
	function (observation, tally) {
		return A2(
			_user$project$Quiz_Observation_Record$Record,
			observation,
			_user$project$Quiz_Observation_Record$Active(tally));
	});
var _user$project$Quiz_Observation_Record$increment = function (state) {
	var _p4 = state;
	if (_p4.ctor === 'Active') {
		return _user$project$Quiz_Observation_Record$Active(_p4._0 + 1);
	} else {
		return state;
	}
};
var _user$project$Quiz_Observation_Record$Struck = {ctor: 'Struck'};
var _user$project$Quiz_Observation_Record$update = F2(
	function (msg, record) {
		var _p5 = msg;
		switch (_p5.ctor) {
			case 'Increment':
				return _elm_lang$core$Native_Utils.update(
					record,
					{
						state: _user$project$Quiz_Observation_Record$increment(record.state)
					});
			case 'Strike':
				return _elm_lang$core$Native_Utils.update(
					record,
					{state: _user$project$Quiz_Observation_Record$Struck});
			default:
				return _elm_lang$core$Native_Utils.update(
					record,
					{
						observation: A2(_user$project$Quiz_Observation$update, _p5._0, record.observation)
					});
		}
	});
var _user$project$Quiz_Observation_Record$stateDecoder = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: _elm_lang$core$Json_Decode$null(_user$project$Quiz_Observation_Record$Struck),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$core$Json_Decode$map, _user$project$Quiz_Observation_Record$Active, _elm_lang$core$Json_Decode$int),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Quiz_Observation_Record$UpdateObservation = function (a) {
	return {ctor: 'UpdateObservation', _0: a};
};
var _user$project$Quiz_Observation_Record$Strike = {ctor: 'Strike'};
var _user$project$Quiz_Observation_Record$Increment = {ctor: 'Increment'};
var _user$project$Quiz_Observation_Record$viewActive = F4(
	function (_p7, observation, tally, _p6) {
		var _p8 = _p7;
		var _p10 = _p8.onUpdate;
		var _p9 = _p6;
		return A2(
			_elm_lang$html$Html$li,
			{
				...
				_0: _user$project$Util$styles(
					{
						...
						_0: _rtfeldman$elm_css$Css$backgroundColor(
							A2(_user$project$Util$fade, _p9.color, tally)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('observation local active'),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('buttons start'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$button,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_p10(_user$project$Quiz_Observation_Record$Increment)),
								_1: {
									ctor: '::',
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										_p9.symbol,
										_elm_lang$core$Basics$toString(tally))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$html$Html$map,
							_user$project$Quiz_Observation_Record$UpdateObservation,
							_user$project$Quiz_Observation$view(observation))),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('buttons end'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$button,
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_p10(_user$project$Quiz_Observation_Record$Strike)),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('strike'),
											_1: {ctor: '[]'}
										}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(_user$project$Util$emdash),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_p8.remove),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('remove'),
												_1: {ctor: '[]'}
...
var _user$project$Quiz_Observation_Record$view = F3(
	function (handlers, theme, _p11) {
		var _p12 = _p11;
		var _p14 = _p12.observation;
		var _p13 = _p12.state;
		if (_p13.ctor === 'Struck') {
			return A2(
				_elm_lang$html$Html$li,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('observation local struck'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			return A4(
				_user$project$Quiz_Observation_Record$viewActive,
				handlers,
				_p14,
				_p13._0,
				A2(_user$project$Quiz_Theme$lookup, _p14.style, theme));
		}
	});

var _user$project$Quiz_Settings$update = F2(
	function (msg, settings) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'AddObservation':
				var style = _mgold$elm_nonempty_list$List_Nonempty$head(
					_user$project$Quiz_Theme$idList(settings.theme));
				return _elm_lang$core$Native_Utils.update(
					settings,
					{
						observations: A2(
							...
							_elm_lang$core$List$singleton(
								{
									ctor: '_Tuple2',
									_0: _elm_lang$core$Basics$toString(settings.nextId),
									_1: A2(_user$project$Quiz_Observation$Observation, style, '')
								})),
						nextId: settings.nextId + 1
					});
			case 'UpdateObservation':
				var updateHelper = function (_p1) {
					var _p2 = _p1;
					var _p4 = _p2._1;
					var _p3 = _p2._0;
					return _elm_lang$core$Native_Utils.eq(_p3, _p0._0) ? {
						ctor: '_Tuple2',
						_0: _p3,
						_1: A2(_user$project$Quiz_Observation$update, _p0._1, _p4)
					} : {ctor: '_Tuple2', _0: _p3, _1: _p4};
				};
				return _elm_lang$core$Native_Utils.update(
					settings,
					{
						observations: A2(_elm_lang$core$List$map, updateHelper, settings.observations)
					});
			case 'RemoveObservation':
				var removeHelper = function (_p5) {
					var _p6 = _p5;
					return !_elm_lang$core$Native_Utils.eq(_p6._0, _p0._0);
				};
				return _elm_lang$core$Native_Utils.update(
					settings,
					{
						observations: A2(_elm_lang$core$List$filter, removeHelper, settings.observations)
					});
			case 'UpdateTheme':
				return _elm_lang$core$Native_Utils.update(
					settings,
					{
						theme: A2(_user$project$Quiz_Theme$update, _p0._0, settings.theme)
					});
			case 'ToggleTally':
				return _elm_lang$core$Native_Utils.update(
					settings,
					{showTally: !settings.showTally});
			default:
				return _elm_lang$core$Native_Utils.update(
					settings,
					{columns: _p0._0});
...
var _user$project$Quiz_Settings$defaultKeys = function (_p7) {
	var _p8 = _p7;
	return A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, _p8.observations);
};
var _user$project$Quiz_Settings$defaultProto = function (theme) {
	return A2(
		_user$project$Quiz_Observation$Observation,
		_mgold$elm_nonempty_list$List_Nonempty$head(theme),
		'');
};
var _user$project$Quiz_Settings$default = function () {
	var theme = _user$project$Quiz_Theme$default;
	return {
		theme: theme,
		showTally: false,
		columns: 4,
		observations: {
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'demo',
				_1: _user$project$Quiz_Settings$defaultProto(
					_user$project$Quiz_Theme$idList(theme))
			},
			_1: {ctor: '[]'}
		},
		nextId: 1
...
var _user$project$Quiz_Settings$Settings = F5(
	function (a, b, c, d, e) {
		return {theme: a, showTally: b, columns: c, observations: d, nextId: e};
	});
var _user$project$Quiz_Settings$SetColumns = function (a) {
	return {ctor: 'SetColumns', _0: a};
};
var _user$project$Quiz_Settings$ToggleTally = {ctor: 'ToggleTally'};
var _user$project$Quiz_Settings$RemoveObservation = function (a) {
	return {ctor: 'RemoveObservation', _0: a};
};
var _user$project$Quiz_Settings$UpdateObservation = F2(
	function (a, b) {
		return {ctor: 'UpdateObservation', _0: a, _1: b};
	});
var _user$project$Quiz_Settings$viewRemovableObservation = F2(
	function (theme, _p9) {
		var _p10 = _p9;
		var _p11 = _p10._0;
		return A3(
			_user$project$Quiz_Observation$viewAsProto,
			{
				onUpdate: _user$project$Quiz_Settings$UpdateObservation(_p11),
				remove: _user$project$Quiz_Settings$RemoveObservation(_p11)
			},
			theme,
			_p10._1);
	});
var _user$project$Quiz_Settings$AddObservation = {ctor: 'AddObservation'};
var _user$project$Quiz_Settings$viewObservations = F2(
	function (theme, observations) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('default-observations'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('observations'),
						_1: {ctor: '[]'}
					},
					A2(
						_elm_lang$core$List$map,
						_user$project$Quiz_Settings$viewRemovableObservation(theme),
						observations)),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Quiz_Settings$AddObservation),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('add-button'),
								_1: {ctor: '[]'}
...
var _user$project$Quiz_Settings$UpdateTheme = function (a) {
	return {ctor: 'UpdateTheme', _0: a};
};
var _user$project$Quiz_Settings$view = function (_p12) {
	var _p13 = _p12;
	var _p14 = _p13.theme;
	return A2(
		_elm_lang$html$Html$div,
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Set up your Quiz'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Observation Categories'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_elm_lang$html$Html$map,
										_user$project$Quiz_Settings$UpdateTheme,
										_user$project$Quiz_Theme$viewAsEditable(_p14)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Default Observations'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Quiz_Settings$viewObservations, _p14, _p13.observations),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _user$project$Quiz_Group$viewTally = F3(
	function (theme, showTally, records) {
		var total = _elm_lang$core$List$sum(
			A2(
				_elm_lang$core$List$map,
				_user$project$Quiz_Observation_Record$value(theme),
				_mrpinsky$elm_keyed_list$KeyedList$toList(records)));
		return A2(
			_elm_lang$html$Html$h2,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'points', _1: true},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'hidden', _1: !showTally},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'pos',
										_1: _elm_lang$core$Native_Utils.cmp(total, 0) > 0
									},
									_1: {ctor: '[]'}
								}
							}
...
var _user$project$Quiz_Group$commit = F2(
	function (current, existing) {
		var _p0 = current;
		if (_p0.ctor === 'Nothing') {
			return existing;
		} else {
			var _p1 = _p0._0;
			return _user$project$Quiz_Observation$isEmpty(_p1) ? existing : A2(
				_mrpinsky$elm_keyed_list$KeyedList$cons,
				A2(_user$project$Quiz_Observation_Record$init, _p1, 1),
				existing);
		}
	});
var _user$project$Quiz_Group$incrementDefault = function (tally) {
	return _elm_lang$core$Maybe$Just(
		A2(
			F2(
				function (x, y) {
			...
			1,
			A2(_elm_lang$core$Maybe$withDefault, 0, tally)));
};
var _user$project$Quiz_Group$update = F2(
	function (msg, group) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'StartNew':
				return _elm_lang$core$Native_Utils.update(
					group,
					{
						current: _elm_lang$core$Maybe$Just(
							_user$project$Quiz_Observation$init(_p2._0))
					});
			case 'UpdateCurrent':
				return _elm_lang$core$Native_Utils.update(
					group,
					{
						current: A2(
							_elm_lang$core$Maybe$map,
							_user$project$Quiz_Observation$update(_p2._0),
							group.current)
					});
			case 'Commit':
				return _elm_lang$core$Native_Utils.update(
					group,
					{
						...
						records: A2(_user$project$Quiz_Group$commit, group.current, group.records)
					});
			case 'IncrementDefault':
				return _elm_lang$core$Native_Utils.update(
					group,
					{
						defaults: A3(_elm_lang$core$Dict$update, _p2._0, _user$project$Quiz_Group$incrementDefault, group.defaults)
					});
			case 'UpdateRecord':
				return _elm_lang$core$Native_Utils.update(
					group,
					{
						records: A3(
							_mrpinsky$elm_keyed_list$KeyedList$update,
							_p2._0,
							_user$project$Quiz_Observation_Record$update(_p2._1),
							group.records)
					});
			case 'Delete':
				return _elm_lang$core$Native_Utils.update(
					group,
					{
						records: A2(_mrpinsky$elm_keyed_list$KeyedList$remove, _p2._0, group.records)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					group,
...
var _user$project$Quiz_Group$Group = F4(
	function (a, b, c, d) {
		return {current: a, label: b, records: c, defaults: d};
	});
var _user$project$Quiz_Group$init = function (label) {
	return A4(_user$project$Quiz_Group$Group, _elm_lang$core$Maybe$Nothing, label, _mrpinsky$elm_keyed_list$KeyedList$empty, _elm_lang$core$Dict$empty);
};
var _user$project$Quiz_Group$Relabel = function (a) {
	return {ctor: 'Relabel', _0: a};
};
var _user$project$Quiz_Group$viewLabel = F2(
	function (_p3, label) {
		var _p4 = _p3;
		return A2(
			_elm_lang$html$Html$div,
				...
				_1: {
					...
					_1: {
						...
						_0: _user$project$Util$onChange(
							function (_p5) {
								return _p4.onUpdate(
									_user$project$Quiz_Group$Relabel(_p5));
							}),
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Quiz_Group$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$Quiz_Group$UpdateRecord = F2(
	function (a, b) {
		return {ctor: 'UpdateRecord', _0: a, _1: b};
	});
var _user$project$Quiz_Group$viewKeyedRecord = F3(
	function (theme, key, record) {
		return A3(
			_user$project$Quiz_Observation_Record$view,
			{
				onUpdate: _user$project$Quiz_Group$UpdateRecord(key),
				remove: _user$project$Quiz_Group$Delete(key)
			},
			theme,
			record);
	});
var _user$project$Quiz_Group$viewLocals = F2(
	function (theme, records) {
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$keyedMap,
			_user$project$Quiz_Group$viewKeyedRecord(theme),
			records);
	});
var _user$project$Quiz_Group$viewRecords = F2(
	function (theme, records) {
		return A2(
			_elm_lang$html$Html$ul,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('observations local'),
				_1: {ctor: '[]'}
			},
			A2(_user$project$Quiz_Group$viewLocals, theme, records));
	});
var _user$project$Quiz_Group$IncrementDefault = function (a) {
	return {ctor: 'IncrementDefault', _0: a};
};
var _user$project$Quiz_Group$viewDefaultObservation = F3(
	function (theme, tallies, _p6) {
		var _p7 = _p6;
		var _p10 = _p7._1;
		var _p9 = _p7._0;
		var _p8 = A2(_user$project$Quiz_Theme$lookup, _p10.style, theme);
		var color = _p8.color;
		var symbol = _p8.symbol;
		var textColor = _p8.textColor;
		var tally = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
			A2(_elm_lang$core$Dict$get, _p9, tallies));
		return A2(
			_elm_lang$html$Html$li,
			{
				ctor: '::',
				_0: _user$project$Util$styles(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$backgroundColor(
							A2(_user$project$Util$fade, color, tally)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('observation default'),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$button,
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Quiz_Group$IncrementDefault(_p9)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('tally'),
							_1: {ctor: '[]'}
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_p10.label),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Quiz_Group$viewDefaults = F3(
	function (theme, defaults, tallies) {
		return A2(
			_elm_lang$html$Html$ul,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('observations default'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Quiz_Group$viewDefaultObservation, theme, tallies),
				defaults));
	});
var _user$project$Quiz_Group$Commit = {ctor: 'Commit'};
var _user$project$Quiz_Group$UpdateCurrent = function (a) {
	return {ctor: 'UpdateCurrent', _0: a};
};
var _user$project$Quiz_Group$StartNew = function (a) {
	return {ctor: 'StartNew', _0: a};
};
var _user$project$Quiz_Group$viewInput = F2(
	function (theme, current) {
		var _p11 = current;
		if (_p11.ctor === 'Nothing') {
			return A2(_user$project$Quiz_Theme$viewAsButtons, _user$project$Quiz_Group$StartNew, theme);
		} else {
			return A3(_user$project$Quiz_Observation$viewCreating, _user$project$Quiz_Group$UpdateCurrent, _user$project$Quiz_Group$Commit, _p11._0);
		}
	});
var _user$project$Quiz_Group$view = F3(
	function (handlers, _p12, group) {
		var _p13 = _p12;
		var _p14 = _p13.theme;
		return A2(
			_elm_lang$html$Html$div,
			...
			{
				ctor: '::',
				_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Quiz_Group$viewLabel, handlers, group.label),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$map,
						...
						A2(
							...
							{
								ctor: '::',
								_0: A4(_elm_lang$html$Html_Lazy$lazy3, _user$project$Quiz_Group$viewTally, _p14, _p13.showTally, group.records),
								_1: {
									ctor: '::',
									_0: A4(_elm_lang$html$Html_Lazy$lazy3, _user$project$Quiz_Group$viewDefaults, _p14, _p13.observations, group.defaults),
									_1: {
										ctor: '::',
										_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Quiz_Group$viewRecords, _p14, group.records),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$div,
												...
												{
													ctor: '::',
													_0: A3(_elm_lang$html$Html_Lazy$lazy2, _user$project$Quiz_Group$viewInput, _p14, group.current),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$Quiz_App$styledButton = F3(
	function (className, msg, label) {
		return A2(
			_elm_lang$html$Html$button,
			{
				ctor: '::',
...
var _user$project$Quiz_App$menuButton = F2(
	function (msg, label) {
		return A3(_user$project$Quiz_App$styledButton, 'menu-button', msg, label);
	});
var _user$project$Quiz_App$numberedGroup = function (n) {
	return _user$project$Quiz_Group$init(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'Group ',
			_elm_lang$core$Basics$toString(n)));
};
var _user$project$Quiz_App$withGroups = function (count) {
	return _mrpinsky$elm_keyed_list$KeyedList$fromList(
		A2(
			_elm_lang$core$List$map,
			_user$project$Quiz_App$numberedGroup,
			A2(_elm_lang$core$List$range, 1, count)));
};
var _user$project$Quiz_App$Model = F3(
	function (a, b, c) {
		return {state: a, settings: b, groups: c};
	});
var _user$project$Quiz_App$Active = {ctor: 'Active'};
var _user$project$Quiz_App$Setup = {ctor: 'Setup'};
var _user$project$Quiz_App$init = function (settings) {
	return A3(
		_user$project$Quiz_App$Model,
		_user$project$Quiz_App$Setup,
		settings,
		_user$project$Quiz_App$withGroups(8));
};
var _user$project$Quiz_App$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'SettingsMsg':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						settings: A2(_user$project$Quiz_Settings$update, _p0._0, model.settings)
					});
			case 'SetUp':
				return _elm_lang$core$Native_Utils.update(
					model,
					{state: _user$project$Quiz_App$Setup});
			case 'Resume':
				return _elm_lang$core$Native_Utils.update(
					model,
					{state: _user$project$Quiz_App$Active});
			case 'AddGroup':
				var newGroup = _user$project$Quiz_Group$init(_p0._0);
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						groups: A2(_mrpinsky$elm_keyed_list$KeyedList$push, newGroup, model.groups)
					});
			case 'UpdateGroup':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						groups: A3(
							_mrpinsky$elm_keyed_list$KeyedList$update,
							_p0._0,
							_user$project$Quiz_Group$update(_p0._1),
							model.groups)
					});
			case 'RemoveGroup':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						groups: A2(_mrpinsky$elm_keyed_list$KeyedList$remove, _p0._0, model.groups)
					});
			default:
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						groups: _user$project$Quiz_App$withGroups(
							_mrpinsky$elm_keyed_list$KeyedList$length(model.groups))
					});
		}
	});
var _user$project$Quiz_App$ResetGroups = {ctor: 'ResetGroups'};
var _user$project$Quiz_App$RemoveGroup = function (a) {
	return {ctor: 'RemoveGroup', _0: a};
};
var _user$project$Quiz_App$UpdateGroup = F2(
	function (a, b) {
		return {ctor: 'UpdateGroup', _0: a, _1: b};
	});
var _user$project$Quiz_App$viewKeyedGroup = F2(
	function (settings, _p1) {
		var _p2 = _p1;
		var _p3 = _p2._0;
		return A3(
			_user$project$Quiz_Group$view,
			{
				onUpdate: _user$project$Quiz_App$UpdateGroup(_p3),
				remove: _user$project$Quiz_App$RemoveGroup(_p3)
			},
			settings,
			_p2._1);
	});
var _user$project$Quiz_App$viewRow = F2(
	function (settings, groups) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Quiz_App$viewKeyedGroup(settings),
				groups));
	});
var _user$project$Quiz_App$viewGroups = F2(
	function (settings, groups) {
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Quiz_App$viewRow(settings),
				A2(
					_user$project$Util$subdivide,
					settings.columns,
					A2(
						...
						F2(
							function (key, item) {
								return {ctor: '_Tuple2', _0: key, _1: item};
							}),
						groups))));
	});
var _user$project$Quiz_App$AddGroup = function (a) {
	return {ctor: 'AddGroup', _0: a};
};
var _user$project$Quiz_App$Resume = {ctor: 'Resume'};
var _user$project$Quiz_App$SetUp = {ctor: 'SetUp'};
var _user$project$Quiz_App$SettingsMsg = function (a) {
	return {ctor: 'SettingsMsg', _0: a};
};
var _user$project$Quiz_App$view = function (_p4) {
	var _p5 = _p4;
	var _p7 = _p5.settings;
	var _p6 = _p5.state;
	if (_p6.ctor === 'Setup') {
		return A2(
			_elm_lang$html$Html$div,
			...
			},
			{
				...
				_0: A2(
					_elm_lang$html$Html$map,
					_user$project$Quiz_App$SettingsMsg,
					_user$project$Quiz_Settings$view(_p7)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Quiz_App$Resume),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('quiz page'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: A2(
							_user$project$Quiz_App$menuButton,
							_user$project$Quiz_App$AddGroup('New Group'),
							'Add Group'),
						_1: {
							ctor: '::',
							_0: A2(_user$project$Quiz_App$menuButton, _user$project$Quiz_App$ResetGroups, 'Reset All Groups'),
							_1: {
								ctor: '::',
								_0: A2(_user$project$Quiz_App$menuButton, _user$project$Quiz_App$SetUp, 'Setup'),
								_1: {ctor: '[]'}
							}
						}
					}),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Quiz_App$viewGroups, _p7, _p5.groups),
					_1: {ctor: '[]'}
				}
			});
	}
};
var _user$project$Quiz_App$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: _user$project$Quiz_App$init(_user$project$Quiz_Settings$default),
		update: _user$project$Quiz_App$update,
		view: _user$project$Quiz_App$view
	})();
...
if (typeof _user$project$App$main !== 'undefined') {
    _user$project$App$main(Elm['App'], 'App', {"types":{"unions":{"Quiz.App.Msg":{"args":[],"tags":{"SetUp":[],"AddGroup":["String"],"SettingsMsg":["Quiz.Settings.Msg"],"UpdateGroup":["KeyedList.Key","Quiz.Group.Msg"],"Resume":[],"RemoveGroup":["KeyedList.Key"],"ResetGroups":[]}},"Quiz.Observation.Record.Msg":{"args":[],"tags":{"Strike":[],"UpdateObservation":["Quiz.Observation.Msg"],"Increment":[]}},"Quiz.Observation.Style.Msg":{"args":[],"tags":{"UpdateColor":["Css.Color"],"UpdateLabel":["String"],"UpdateSymbol":["String"],"UpdateWeight":["Int"],"UpdateTextColor":["Css.Color"]}},"KeyedList.Key":{"args":[],"tags":{"Key":["Int"]}},"Css.Compatible":{"args":[],"tags":{"Compatible":[]}},"Quiz.Group.Msg":{"args":[],"tags":{"UpdateRecord":["KeyedList.Key","Quiz.Observation.Record.Msg"],"IncrementDefault":["String"],"UpdateCurrent":["Quiz.Observation.Msg"],"StartNew":["Quiz.Theme.Id"],"Commit":[],"Relabel":["String"],"Delete":["KeyedList.Key"]}},"Quiz.Observation.Msg":{"args":[],"tags":{"UpdateLabel":["String"],"UpdateStyle":["Quiz.Theme.Id"]}},"Quiz.Theme.Msg":{"args":[],"tags":{"Remove":["Quiz.Theme.Id"],"Add":[],"UpdateStyle":["Quiz.Theme.Id","Quiz.Observation.Style.Msg"]}},"Quiz.Settings.Msg":{"args":[],"tags":{"RemoveObservation":["String"],"AddObservation":[],"ToggleTally":[],"SetColumns":["Int"],"UpdateTheme":["Quiz.Theme.Msg"],"UpdateObservation":["String","Quiz.Observation.Msg"]}}},"aliases":{"Quiz.Theme.Id":{"args":[],"type":"String"},"Css.Color":{"args":[],"type":"Css.ColorValue { red : Int, green : Int, blue : Int, alpha : Float }"},"Css.ColorValue":{"args":["compatible"],"type":"{ compatible | value : String, color : Css.Compatible, warnings : List String }"}},"message":"Quiz.App.Msg"},"versions":{"elm":"0.18.0"}});
}
...
// module
exports.push([module.i, "html, body, #pquiz, .page {\n  height: 100%;\n  margin: 0; }\n\nh2 {\n  margin: 12px 0; }\n\nbutton {\n  border: 0; }\n\n.hidden {\n  display: none; }\n\n.quiz {\n  display: flex;\n  flex-direction: column; }\n\n.menu-bar {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  margin-bottom: .25em; }\n  .menu-bar button {\n    margin: 2px;\n    font-size: 1em; }\n\n.remove {\n  display: flex;\n  flex-direction: column;\n  font-size: .9em;\n  position: absolute;\n  right: 0;\n  background: transparent !important; }\n\n.groups {\n  flex: 0 1 100%; }\n\n.row {\n  display: flex;\n  flex-direction: row;\n  height: 50%; }\n\n.group {\n  display: flex;\n  flex-direction: column;\n  border: 2px solid #000;\n  border-radius: 6px;\n  margin: 5px;\n  width: 100%; }\n  .group .title, .group .points {\n    font-size: calc(1vw + 1vh + 1vmin); }\n  .group .title {\n    cursor: text;\n    font-family: sans-serif;\n    font-weight: bold;\n    padding: 0 .2em .2em;\n    overflow: hidden;\n    text-align: center;\n    word-wrap: break-word;\n    border-bottom: 1px solid #000;\n    background: #ddd;\n    position: relative; }\n    .group .title .remove {\n      position: absolute;\n      right: 0;\n      font-size: .5em;\n      opacity: 0;\n      transition: opacity .2s ease-in-out; }\n    .group .title:hover .remove {\n      opacity: 1; }\n  .group .body {\n    display: flex;\n    flex-direction: column;\n    flex: 0 1 100%; }\n    .group .body .points {\n      text-align: center;\n      margin: 0; }\n    .group .body .input {\n      height: 2em; }\n      .group .body .input > * {\n        height: 100%; }\n      .group .body .input input {\n        font-size: 1.5em;\n        padding-left: 5px;\n        width: 100%;\n        box-sizing: border-box;\n        border-top: 1px solid #000;\n        border-left: 0;\n        border-right: 0;\n        border-bottom: 1px solid #000;\n        outline: none; }\n      .group .body .input .topic {\n        border-top: 3px solid #000;\n        border-left: 1px solid #000;\n        border-right: 1px solid #000;\n        height: 100%;\n        margin-top: auto; }\n        .group .body .input .topic:first-child {\n          border-left: 0; }\n        .group .body .input .topic:last-child {\n          border-right: 0; }\n    .group .body .theme {\n      display: flex; }\n    .group .body .observations {\n      margin: 0;\n      padding: 0;\n      list-style: none;\n      overflow-y: auto; }\n      .group .body .observations.default {\n        flex: 1 0 auto; }\n      .group .body .observations.local {\n        flex: 1 1 100%; }\n    .group .body .observation {\n      display: flex;\n      padding: 5px; }\n      .group .body .observation .label {\n        width: 100%;\n        padding: 5px;\n        font-weight: bold;\n        font-family: sans-serif;\n        font-size: 1.2em; }\n      .group .body .observation .tally {\n        display: flex;\n        flex: 1 0 auto;\n        font-weight: bold;\n        font-size: 1em; }\n      .group .body .observation button {\n        background: transparent; }\n      .group .body .observation .buttons {\n        display: flex;\n        flex: 1 0 auto; }\n      .group .body .observation .strike {\n        margin-left: auto; }\n\n.settings {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: #1c7556; }\n  .settings * {\n    background: #fff; }\n  .settings .content {\n    height: 100%;\n    width: 500px;\n    padding: 10px; }\n    .settings .content h1 {\n      margin-top: 0; }\n  .settings .observation {\n    display: flex;\n    flex: 0 1 100%;\n    font-size: 1rem; }\n    .settings .observation .label {\n      flex: 0 1 100%; }\n  .settings ul {\n    list-style: none;\n    padding: 0;\n    margin: 0; }\n  .settings li {\n    padding-top: .5em;\n    padding-bottom: .5em;\n    border-bottom: 1px solid black;\n    position: relative; }\n    .settings li:last-child {\n      border: none; }\n\n.add-button {\n  font-size: 1.5em;\n  background: #1c7556;\n  color: #fff;\n  width: 1.5em;\n  border-radius: 7%; }\n\n.topic.button {\n  flex: 1 1 100%;\n  font-weight: bold;\n  font-size: calc(1vw + 1vh);\n  padding: 3px; }\n\n.topic.editable {\n  display: block; }\n  .topic.editable .row {\n    display: flex;\n    flex-direction: row; }\n\n.field {\n  display: flex;\n  flex: 1 1 auto;\n  text-transform: uppercase;\n  font-family: sans-serif;\n  font-size: .7em;\n  position: relative; }\n  .field div {\n    display: block;\n    margin: 3px;\n    position: absolute;\n    height: 20px;\n    top: 0px;\n    font-size: 0.9em; }\n  .field input,\n  .field select {\n    width: 100%;\n    position: relative;\n    font-weight: bold;\n    font-family: sans-serif;\n    margin: 20px 3px 3px;\n    border: 1px solid #ddd;\n    outline: none;\n    font-size: 1rem; }\n  .field select {\n    border-top: none;\n    border-left: none;\n    border-right: none; }\n  .field input {\n    padding: 2px 4px; }\n\n.small-fields .field {\n  display: flex;\n  flex: 1 1 1%; }\n  .small-fields .field input {\n    flex: 1 1 auto;\n    text-align: center; }\n", ""]);
