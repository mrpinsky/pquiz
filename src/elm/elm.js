...
var _user$project$Util$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _user$project$Util$onContentEdit = function (msg) {
...
var _user$project$Util$stringFromCode = function (_p1) {
...
var _user$project$Util$ordinal = function (n) {
	var _p2 = n;
	switch (_p2) {
		case 1:
			return 'first';
