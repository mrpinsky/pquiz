...
var _mrpinsky$elm_keyed_list$KeyedList$length = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$List$length(_p1._1);
};
var _mrpinsky$elm_keyed_list$KeyedList$isEmpty = function (_p2) {
	var _p3 = _p2;
	return _elm_lang$core$List$isEmpty(_p3._1);
};
var _mrpinsky$elm_keyed_list$KeyedList$keyedMap = F2(
	function (fn, _p4) {
		var _p5 = _p4;
		var keyedMapHelper = function (_p6) {
			var _p7 = _p6;
			return A2(fn, _p7._0, _p7._1);
		};
		return A2(_elm_lang$core$List$map, keyedMapHelper, _p5._1);
	});
var _mrpinsky$elm_keyed_list$KeyedList$toList = function (_p8) {
	var _p9 = _p8;
...
var _mrpinsky$elm_keyed_list$KeyedList$remove = F2(
	function (key, _p12) {
		var _p13 = _p12;
		var removeHelper = function (_p14) {
			var _p15 = _p14;
			return !_elm_lang$core$Native_Utils.eq(_p15._0, key);
		};
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p13._0,
			A2(_elm_lang$core$List$filter, removeHelper, _p13._1));
	});
var _mrpinsky$elm_keyed_list$KeyedList$filter = F2(
	function (predicate, _p16) {
		var _p17 = _p16;
		var filterHelper = function (_p18) {
			var _p19 = _p18;
			return predicate(_p19._1);
		};
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p17._0,
			A2(_elm_lang$core$List$filter, filterHelper, _p17._1));
	});
...
var _mrpinsky$elm_keyed_list$KeyedList$update = F3(
	function (key, fn, _p20) {
		var _p21 = _p20;
		var updateHelper = function (_p22) {
			var _p23 = _p22;
			var _p25 = _p23._1;
			var _p24 = _p23._0;
			return _elm_lang$core$Native_Utils.eq(_p24, key) ? A2(
				_mrpinsky$elm_keyed_list$KeyedList$Keyed,
				_p24,
				fn(_p25)) : A2(_mrpinsky$elm_keyed_list$KeyedList$Keyed, _p24, _p25);
		};
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p21._0,
			A2(_elm_lang$core$List$map, updateHelper, _p21._1));
	});
var _mrpinsky$elm_keyed_list$KeyedList$map = F2(
	function (fn, _p26) {
		var _p27 = _p26;
		var mapHelper = function (_p28) {
			var _p29 = _p28;
			return A2(
				_mrpinsky$elm_keyed_list$KeyedList$Keyed,
				_p29._0,
		...
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_p27._0,
			A2(_elm_lang$core$List$map, mapHelper, _p27._1));
	});
...
var _mrpinsky$elm_keyed_list$KeyedList$empty = A2(
	...
	{ctor: '[]'});
var _mrpinsky$elm_keyed_list$KeyedList$next = function (_p30) {
	var _p31 = _p30;
	return _mrpinsky$elm_keyed_list$KeyedList$Key(_p31._0 + 1);
};
var _mrpinsky$elm_keyed_list$KeyedList$cons = F2(
	function (item, _p32) {
		...
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_mrpinsky$elm_keyed_list$KeyedList$next(_p34),
			{
				ctor: '::',
				_0: A2(_mrpinsky$elm_keyed_list$KeyedList$Keyed, _p34, item),
				_1: _p33._1
			});
	});
var _mrpinsky$elm_keyed_list$KeyedList$push = F2(
	function (item, _p35) {
		...
		return A2(
			_mrpinsky$elm_keyed_list$KeyedList$KeyedList,
			_mrpinsky$elm_keyed_list$KeyedList$next(_p37),
			A2(
				F2(
					function (x, y) {
				...
				_elm_lang$core$List$singleton(
					A2(_mrpinsky$elm_keyed_list$KeyedList$Keyed, _p37, item))));
	});
...
var _mrpinsky$pquiz$Quiz_Config$Config = F2(
	function (a, b) {
		return {kinds: a, tally: b};
	});
var _mrpinsky$pquiz$Quiz_Config$KindSettings = F3(
	function (a, b, c) {
		return {symbol: a, color: b, weight: c};
	});
...
var _mrpinsky$pquiz$Util$keyedListDecoder = function (decoder) {
	return A2(
		_elm_lang$core$Json_Decode$map,
		_mrpinsky$elm_keyed_list$KeyedList$fromList,
		_elm_lang$core$Json_Decode$list(decoder));
};
var _mrpinsky$pquiz$Util$styles = function (_p0) {
	return _elm_lang$html$Html_Attributes$style(
		_rtfeldman$elm_css$Css$asPairs(_p0));
};
var _mrpinsky$pquiz$Util$onContentEdit = function (msg) {
	...
	return A2(
		_elm_lang$html$Html_Events$on,
		'blur',
		A2(_elm_lang$core$Json_Decode$map, msg, innerHtmlDecoder));
};
var _mrpinsky$pquiz$Util$onEnter = function (msg) {
...
var _mrpinsky$pquiz$Util$stringFromCode = function (_p1) {
	return _elm_lang$core$String$fromChar(
		_elm_lang$core$Char$fromCode(_p1));
};
var _mrpinsky$pquiz$Util$delta = _mrpinsky$pquiz$Util$stringFromCode(916);
var _mrpinsky$pquiz$Util$emdash = _mrpinsky$pquiz$Util$stringFromCode(8212);
var _mrpinsky$pquiz$Util$checkmark = _mrpinsky$pquiz$Util$stringFromCode(10004);
var _mrpinsky$pquiz$Util$ordinal = function (n) {
	var _p2 = n;
	switch (_p2) {
		case 1:
			return 'first';
...
var _mrpinsky$pquiz$Util$encodeMaybe = F2(
...
var _mrpinsky$pquiz$Util_ops = _mrpinsky$pquiz$Util_ops || {};
_mrpinsky$pquiz$Util_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});

var _mrpinsky$pquiz$Quiz_Observation$stateToInt = function (state) {
	var _p0 = state;
	if (_p0.ctor === 'Struck') {
		return -1;
	} else {
...
var _mrpinsky$pquiz$Quiz_Observation$encodeState = function (state) {
	return _elm_lang$core$Json_Encode$int(
		_mrpinsky$pquiz$Quiz_Observation$stateToInt(state));
};
var _mrpinsky$pquiz$Quiz_Observation$encode = function (_p1) {
	var _p2 = _p1;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: A2(
				_mrpinsky$pquiz$Util_ops['=>'],
				'kind',
			...
			_1: {
				...
				_0: A2(
					...
					_elm_lang$core$Json_Encode$int(
						_mrpinsky$pquiz$Quiz_Observation$stateToInt(_p2._2))),
				_1: {
					ctor: '::',
					_0: A2(
						_mrpinsky$pquiz$Util_ops['=>'],
						'label',
						_elm_lang$core$Json_Encode$string(_p2._1)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _mrpinsky$pquiz$Quiz_Observation$Observation = F3(
	function (a, b, c) {
		return {ctor: 'Observation', _0: a, _1: b, _2: c};
	});
var _mrpinsky$pquiz$Quiz_Observation$relabel = F2(
	function (newLabel, _p3) {
		var _p4 = _p3;
		return A3(_mrpinsky$pquiz$Quiz_Observation$Observation, _p4._0, newLabel, _p4._2);
	});
var _mrpinsky$pquiz$Quiz_Observation$Active = function (a) {
	return {ctor: 'Active', _0: a};
};
var _mrpinsky$pquiz$Quiz_Observation$init = F3(
	function (kind, label, tally) {
		return A3(
			_mrpinsky$pquiz$Quiz_Observation$Observation,
			kind,
			label,
			_mrpinsky$pquiz$Quiz_Observation$Active(tally));
	});
var _mrpinsky$pquiz$Quiz_Observation$Struck = {ctor: 'Struck'};
var _mrpinsky$pquiz$Quiz_Observation$stateFromInt = function (tally) {
	return (_elm_lang$core$Native_Utils.cmp(tally, 0) < 0) ? _mrpinsky$pquiz$Quiz_Observation$Struck : _mrpinsky$pquiz$Quiz_Observation$Active(tally);
};
var _mrpinsky$pquiz$Quiz_Observation$stateDecoder = A2(_elm_lang$core$Json_Decode$map, _mrpinsky$pquiz$Quiz_Observation$stateFromInt, _elm_lang$core$Json_Decode$int);
var _mrpinsky$pquiz$Quiz_Observation$decoder = A4(
	...
	A2(_elm_lang$core$Json_Decode$field, 'state', _mrpinsky$pquiz$Quiz_Observation$stateDecoder));
var _mrpinsky$pquiz$Quiz_Observation$update = F2(
	function (msg, _p5) {
		var _p6 = _p5;
		var _p11 = _p6._2;
		var _p10 = _p6._1;
		...
		switch (_p7.ctor) {
			case 'Relabel':
				return A3(_mrpinsky$pquiz$Quiz_Observation$Observation, _p9, _p7._0, _p11);
			case 'Increment':
				var _p8 = _p11;
				if (_p8.ctor === 'Struck') {
					return A3(_mrpinsky$pquiz$Quiz_Observation$Observation, _p9, _p10, _mrpinsky$pquiz$Quiz_Observation$Struck);
				} else {
					return A3(
						_mrpinsky$pquiz$Quiz_Observation$Observation,
						_p9,
						_p10,
						_mrpinsky$pquiz$Quiz_Observation$Active(_p8._0 + 1));
				}
			default:
				return A3(_mrpinsky$pquiz$Quiz_Observation$Observation, _p9, _p10, _mrpinsky$pquiz$Quiz_Observation$Struck);
		}
	});
var _mrpinsky$pquiz$Quiz_Observation$Strike = {ctor: 'Strike'};
var _mrpinsky$pquiz$Quiz_Observation$Increment = {ctor: 'Increment'};
var _mrpinsky$pquiz$Quiz_Observation$Relabel = function (a) {
	return {ctor: 'Relabel', _0: a};
};
var _mrpinsky$pquiz$Quiz_Observation$view = F2(
	function (config, _p12) {
		var _p13 = _p12;
		var _p16 = _p13._1;
		var kindConfig = A2(_elm_lang$core$Dict$get, _p13._0, config.kinds);
		var symbol = A2(
			_elm_lang$core$Maybe$withDefault,
			_mrpinsky$pquiz$Util$checkmark,
			A2(
				_elm_lang$core$Maybe$map,
				function (_p14) {
					return _elm_lang$core$String$fromChar(
		...
		if (_p15.ctor === 'Struck') {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('struck'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			return A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_mrpinsky$pquiz$Quiz_Observation$Increment),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$span,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_mrpinsky$pquiz$Quiz_Observation$Relabel),
									_1: {ctor: '[]'}
								}
							},
							{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_mrpinsky$pquiz$Quiz_Observation$Strike),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(_mrpinsky$pquiz$Util$emdash),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _mrpinsky$pquiz$Quiz_Group$encode = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					_elm_lang$core$Json_Encode$list(
						A2(
							_elm_lang$core$List$map,
							_mrpinsky$pquiz$Quiz_Observation$encode,
							_mrpinsky$elm_keyed_list$KeyedList$toList(_p1._1)))),
				_1: {
					ctor: '::',
					_0: A2(
						_mrpinsky$pquiz$Util_ops['=>'],
						'current',
						A2(_mrpinsky$pquiz$Util$encodeMaybe, _mrpinsky$pquiz$Quiz_Observation$encode, _p1._2)),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _mrpinsky$pquiz$Quiz_Group$testConfig = function () {
	var kinds = _elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: A2(
				_mrpinsky$pquiz$Util_ops['=>'],
				'+',
				{
					symbol: _elm_lang$core$Native_Utils.chr('+'),
	...
	return {kinds: kinds, tally: false};
}();
var _mrpinsky$pquiz$Quiz_Group$Group = F3(
	function (a, b, c) {
		return {ctor: 'Group', _0: a, _1: b, _2: c};
	});
var _mrpinsky$pquiz$Quiz_Group$init = F2(
	function (label, observations) {
		return A3(
			_mrpinsky$pquiz$Quiz_Group$Group,
			label,
			_mrpinsky$elm_keyed_list$KeyedList$fromList(observations),
			_elm_lang$core$Maybe$Nothing);
	});
var _mrpinsky$pquiz$Quiz_Group$decoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_mrpinsky$pquiz$Quiz_Group$Group,
	A2(_elm_lang$core$Json_Decode$field, 'label', _elm_lang$core$Json_Decode$string),
	A2(
		...
		'observations',
		_mrpinsky$pquiz$Util$keyedListDecoder(_mrpinsky$pquiz$Quiz_Observation$decoder)),
	A2(
		_elm_lang$core$Json_Decode$field,
		'current',
		_elm_lang$core$Json_Decode$maybe(_mrpinsky$pquiz$Quiz_Observation$decoder)));
var _mrpinsky$pquiz$Quiz_Group$update = F2(
	function (msg, _p2) {
		var _p3 = _p2;
		var _p8 = _p3._1;
		var _p7 = _p3._0;
			...
			case 'StartNew':
				return A3(
					...
					_elm_lang$core$Maybe$Just(
						A3(_mrpinsky$pquiz$Quiz_Observation$init, _p4._0, '', 1)));
			case 'UpdateCurrent':
				var newCurrent = A2(
					_elm_lang$core$Maybe$map,
					_mrpinsky$pquiz$Quiz_Observation$relabel(_p4._0),
					_p6);
				return A3(_mrpinsky$pquiz$Quiz_Group$Group, _p7, _p8, newCurrent);
			case 'SaveCurrent':
				var _p5 = _p6;
				if (_p5.ctor === 'Nothing') {
					return A3(_mrpinsky$pquiz$Quiz_Group$Group, _p7, _p8, _elm_lang$core$Maybe$Nothing);
				} else {
					var newObservations = A2(_mrpinsky$elm_keyed_list$KeyedList$cons, _p5._0, _p8);
					return A3(_mrpinsky$pquiz$Quiz_Group$Group, _p7, newObservations, _elm_lang$core$Maybe$Nothing);
				}
			case 'UpdateExisting':
				var newObservations = A3(
					_mrpinsky$elm_keyed_list$KeyedList$update,
					_p4._0,
					_mrpinsky$pquiz$Quiz_Observation$update(_p4._1),
					_p8);
				return A3(_mrpinsky$pquiz$Quiz_Group$Group, _p7, newObservations, _p6);
			case 'Delete':
				var newObservations = A2(_mrpinsky$elm_keyed_list$KeyedList$remove, _p4._0, _p8);
				return A3(_mrpinsky$pquiz$Quiz_Group$Group, _p7, newObservations, _p6);
			default:
				return A3(_mrpinsky$pquiz$Quiz_Group$Group, _p4._0, _p8, _p6);
		}
	});
var _mrpinsky$pquiz$Quiz_Group$Relabel = function (a) {
	return {ctor: 'Relabel', _0: a};
};
var _mrpinsky$pquiz$Quiz_Group$viewLabel = function (label) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _mrpinsky$pquiz$Util$onContentEdit(_mrpinsky$pquiz$Quiz_Group$Relabel),
					_1: {ctor: '[]'}
				}
			}
		},
...
var _mrpinsky$pquiz$Quiz_Group$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _mrpinsky$pquiz$Quiz_Group$UpdateExisting = F2(
	function (a, b) {
		return {ctor: 'UpdateExisting', _0: a, _1: b};
	});
var _mrpinsky$pquiz$Quiz_Group$viewKeyedObservation = F3(
	function (config, key, observation) {
		var inner = A2(
			_elm_lang$html$Html$map,
			_mrpinsky$pquiz$Quiz_Group$UpdateExisting(key),
			A2(_mrpinsky$pquiz$Quiz_Observation$view, config, observation));
		return A2(
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_mrpinsky$pquiz$Quiz_Group$Delete(key)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _mrpinsky$pquiz$Quiz_Group$viewObservations = F2(
	function (config, observations) {
		return A2(
			_elm_lang$html$Html$ul,
			{ctor: '[]'},
			A2(
				_mrpinsky$elm_keyed_list$KeyedList$keyedMap,
				_mrpinsky$pquiz$Quiz_Group$viewKeyedObservation(config),
				observations));
	});
var _mrpinsky$pquiz$Quiz_Group$SaveCurrent = {ctor: 'SaveCurrent'};
var _mrpinsky$pquiz$Quiz_Group$UpdateCurrent = function (a) {
	return {ctor: 'UpdateCurrent', _0: a};
};
var _mrpinsky$pquiz$Quiz_Group$StartNew = function (a) {
	return {ctor: 'StartNew', _0: a};
};
var _mrpinsky$pquiz$Quiz_Group$viewButton = function (_p9) {
	var _p10 = _p9;
	var _p11 = _p10._0;
	return A2(
		_elm_lang$html$Html$button,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Events$onClick(
				_mrpinsky$pquiz$Quiz_Group$StartNew(_p11)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('input-button'),
				_1: {
					ctor: '::',
					_0: _mrpinsky$pquiz$Util$styles(
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$backgroundColor(_p10._1.color),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _mrpinsky$pquiz$Quiz_Group$viewButtons = function (config) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		A2(
			_elm_lang$core$List$map,
			_mrpinsky$pquiz$Quiz_Group$viewButton,
			_elm_lang$core$Dict$toList(config.kinds)));
};
var _mrpinsky$pquiz$Quiz_Group$viewCurrent = F3(
	function (id, config, obs) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _mrpinsky$pquiz$Quiz_Group$viewButtons(config),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Observation'),
							_1: {
								ctor: '::',
								_0: _mrpinsky$pquiz$Util$onEnter(_mrpinsky$pquiz$Quiz_Group$SaveCurrent),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_mrpinsky$pquiz$Quiz_Group$UpdateCurrent),
									_1: {
										ctor: '::',
...
var _mrpinsky$pquiz$Quiz_Group$view = F3(
	function (id, config, _p12) {
		var _p13 = _p12;
		return A2(
			_elm_lang$html$Html$div,
			{
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Lazy$lazy, _mrpinsky$pquiz$Quiz_Group$viewLabel, _p13._0),
				_1: {
					ctor: '::',
					_0: A4(_elm_lang$html$Html_Lazy$lazy3, _mrpinsky$pquiz$Quiz_Group$viewCurrent, id, config, _p13._2),
					_1: {
						ctor: '::',
						_0: A3(_elm_lang$html$Html_Lazy$lazy2, _mrpinsky$pquiz$Quiz_Group$viewObservations, config, _p13._1),
						_1: {ctor: '[]'}
					}
				}
			});
	});
var _mrpinsky$pquiz$Quiz_Group$main = _elm_lang$html$Html$beginnerProgram(
	{
		model: A2(
			_mrpinsky$pquiz$Quiz_Group$init,
			'Test Group',
			{ctor: '[]'}),
		update: _mrpinsky$pquiz$Quiz_Group$update,
		view: A2(_mrpinsky$pquiz$Quiz_Group$view, 1, _mrpinsky$pquiz$Quiz_Group$testConfig)
	})();

var Elm = {};
Elm['Quiz'] = Elm['Quiz'] || {};
Elm['Quiz']['Group'] = Elm['Quiz']['Group'] || {};
if (typeof _mrpinsky$pquiz$Quiz_Group$main !== 'undefined') {
    _mrpinsky$pquiz$Quiz_Group$main(Elm['Quiz']['Group'], 'Quiz.Group', undefined);
}
